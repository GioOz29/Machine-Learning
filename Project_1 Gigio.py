...
"""remove ph colomn so that we can do regressionon on it in the future,
    and removed the dcolumn names from the matrix"""
Y = dataset['ph']
...
"""i dont like too much this part becaus im missing something this code is not working"""
